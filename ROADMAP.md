...
- Convert the JavaScript to TypeScript piecemeal.
  ...
  - [ ] Convert small, dependency-light foundations first: math, animation,
    ...
    - [ ] Convert the event emitter and event buffer.
    - [ ] Convert bounding boxes, the timer, and keyboard/input state.
  - [ ] Convert rendering and world primitives: sprite sheets, compositors,
        cameras, tiles, collision resolution, scenes, and levels.
    - [ ] Convert sprite sheets, compositors, and cameras.
    - [ ] Convert tile storage and collision resolution.
    - [ ] Convert scenes, scene runners, and levels.
